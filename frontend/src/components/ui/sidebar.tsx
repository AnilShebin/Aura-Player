...
function Sidebar({
  ...
  side?: "left" | "right"
  variant?: "sidebar" | "floating" | "inset" | "transparent"
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border group-data-[variant=transparent]:bg-transparent"
        >
          {children}
        </div>
      </div>
