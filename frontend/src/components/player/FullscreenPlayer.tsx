      ...
      <div className="absolute inset-0 flex flex-col md:flex-row z-10 overflow-hidden">
        ...
        >
          <div className="w-full max-w-[340px] lg:max-w-[420px] flex flex-col items-center min-h-0">
            ...
            {/* Quality badge */}
            {qualityLabel && (
              <div className="flex items-center justify-center gap-1.5 mb-5 opacity-50">
                ...
                <span className="text-[11px] font-semibold tracking-wide text-white/90">{qualityLabel}</span>
              </div>
            )}
